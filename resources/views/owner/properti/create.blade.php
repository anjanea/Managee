...
@section('title', 'Managee Owner - Tambah Properti Baru')
@section('page_title', 'Tambah Properti')
...
<div class="owner-form-container" style="background: white; border: 1px solid var(--border); border-radius: var(--radius-lg); padding: 2.5rem; max-width: 850px; margin: 0 auto; box-shadow: var(--shadow-sm);">
    <div class="form-header" style="position: relative; margin-bottom: 2rem;">
        ...
        <h3 style="font-size: 1.5rem; font-weight: 700; color: var(--primary); margin: 0 0 0.25rem 0; line-height: 1.2;">Tambah Properti Baru</h3>
        <p style="color: var(--text-muted); font-size: 0.9rem; margin: 0;">Isi detail properti yang ingin Anda tambahkan</p>
    </div>
    ...
    <form action="{{ route('owner.properties.store') }}" method="POST" id="property-form" enctype="multipart/form-data" class="owner-form" style="display: flex; flex-direction: column; gap: 2rem;">
        ...
        <div class="wizard-step" id="wizard-step-1">
            ...
            <div style="display: flex; flex-direction: column; gap: 1.25rem;">
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title') }}" placeholder="Tulis nama properti..." style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-md); outline: none; margin-top: 0.25rem;" required>
                    @error('title')
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="location" name="location" value="{{ old('location') }}" placeholder="Contoh: Ubud, Bali atau Kuta, Bali" style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-md); outline: none; margin-top: 0.25rem;" required>
                    @error('location')
                        <span style="color: #ef4444; font-size: 0.85rem; margin-top: 0.25rem; display: block;">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="address" name="address" value="{{ old('address') }}" placeholder="Tulis alamat lengkap..." style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-md); outline: none; margin-top: 0.25rem;" required>
                    @error('address')
                        <span style="color: #ef4444; font-size: 0.85rem; margin-top: 0.25rem; display: block;">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" rows="5" placeholder="Tulis deskripsi rinci properti..." style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-md); outline: none; margin-top: 0.25rem; font-family: inherit;">{{ old('description') }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 1.25rem; margin-bottom: 2rem;">
                <div class="form-row" style="display: flex; gap: 1rem;">
                    <div class="form-group" style="flex: 1;">
                        ...
                        <input type="number" id="bedrooms" name="bedrooms" value="{{ old('bedrooms') }}" placeholder="Jumlah..." style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-md); outline: none; margin-top: 0.25rem;">
                    </div>
                    <div class="form-group" style="flex: 1;">
                        <label for="bathrooms" style="font-weight: 600; font-size: 0.9rem;">Kamar Mandi</label>
                        <input type="number" id="bathrooms" name="bathrooms" value="{{ old('bathrooms') }}" placeholder="Jumlah..." style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-md); outline: none; margin-top: 0.25rem;">
                    </div>
                    <div class="form-group" style="flex: 1;">
                        <label for="area" style="font-weight: 600; font-size: 0.9rem;">Luas (m2) *</label>
                        <input type="number" id="area" name="area" value="{{ old('area') }}" placeholder="Luas..." style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-md); outline: none; margin-top: 0.25rem;" required>
                    </div>
                </div>
                ...
                <div class="form-row" style="display: flex; gap: 1.5rem;">
                    <div class="form-group" style="flex: 1;">
                        ...
                        <input type="number" id="floors" name="floors" value="{{ old('floors') }}" placeholder="Contoh: 2" style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-md); outline: none; margin-top: 0.25rem;">
                    </div>
                    <div class="form-group" style="flex: 1;">
                        <label for="garage" style="font-weight: 600; font-size: 0.9rem;">Garasi</label>
                        <input type="text" id="garage" name="garage" value="{{ old('garage') }}" placeholder="Contoh: 1 Mobil, 2 Motor" style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-md); outline: none; margin-top: 0.25rem;">
                    </div>
                </div>
                ...
                <div class="form-row" style="display: flex; gap: 1.5rem;">
                    <div class="form-group" style="flex: 1;">
                        ...
                        <input type="number" id="year_built" name="year_built" value="{{ old('year_built') }}" placeholder="Contoh: 2021" style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-md); outline: none; margin-top: 0.25rem;">
                    </div>
                    <div class="form-group" style="flex: 1;">
                        <label for="certificate" style="font-weight: 600; font-size: 0.9rem;">Sertifikat</label>
                        <input type="text" id="certificate" name="certificate" value="{{ old('certificate') }}" placeholder="Contoh: SHM, HGB" style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-md); outline: none; margin-top: 0.25rem;">
                    </div>
                </div>
                ...
                <div class="form-row" style="display: flex; gap: 1.5rem;">
                    <div class="form-group" style="flex: 1;">
                        ...
                        <input type="number" id="electricity" name="electricity" value="{{ old('electricity') }}" placeholder="Contoh: 2200" style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-md); outline: none; margin-top: 0.25rem;">
                    </div>
                    <div class="form-group" style="flex: 1;">
                        <label for="water_source" style="font-weight: 600; font-size: 0.9rem;">Sumber Air</label>
                        <input type="text" id="water_source" name="water_source" value="{{ old('water_source') }}" placeholder="Contoh: PDAM, Sumur Bor" style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-md); outline: none; margin-top: 0.25rem;">
                    </div>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem;">
                ...
                <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="AC" {{ is_array(old('facilities')) && in_array('AC', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
                        <span>AC</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="Wi-Fi" {{ is_array(old('facilities')) && in_array('Wi-Fi', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
                        <span>Wi-Fi</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="Kolam Renang" {{ is_array(old('facilities')) && in_array('Kolam Renang', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
                        <span>Kolam Renang</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="Taman" {{ is_array(old('facilities')) && in_array('Taman', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
                        <span>Taman</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="Keamanan 24 Jam" {{ is_array(old('facilities')) && in_array('Keamanan 24 Jam', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
                ...
                <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="Dapur" {{ is_array(old('facilities')) && in_array('Dapur', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
                        <span>Dapur</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="Laundry" {{ is_array(old('facilities')) && in_array('Laundry', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
                        <span>Laundry</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="Playground" {{ is_array(old('facilities')) && in_array('Playground', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
                        <span>Playground</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="Furniture" {{ is_array(old('facilities')) && in_array('Furniture', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
                        <span>Furniture</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="TV Kabel" {{ is_array(old('facilities')) && in_array('TV Kabel', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
                        <span>TV Kabel</span>
                    </label>
                </div>
                <!-- Column 3 -->
                <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="Gym" {{ is_array(old('facilities')) && in_array('Gym', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
                        <span>Gym</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="Garasi" {{ is_array(old('facilities')) && in_array('Garasi', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
                        <span>Garasi</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="CCTV" {{ is_array(old('facilities')) && in_array('CCTV', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
                        <span>CCTV</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="Balkon" {{ is_array(old('facilities')) && in_array('Balkon', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
                        <span>Balkon</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; cursor: pointer;">
                        <input type="checkbox" name="facilities[]" value="Parkir Motor" {{ is_array(old('facilities')) && in_array('Parkir Motor', old('facilities')) ? 'checked' : '' }} style="accent-color: var(--primary);">
        ...
        <div class="wizard-step" id="wizard-step-3" style="display: none;">
            ...
            <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                ...
                <div style="background: var(--bg-light); border: 2px dashed var(--border); border-radius: var(--radius-lg); padding: 2rem; text-align: center; position: relative; cursor: pointer; transition: var(--transition);" onmouseover="this.style.borderColor='var(--primary)'" onmouseout="this.style.borderColor='var(--border)'">
                    ...
                    <p style="font-weight: 600; font-size: 0.95rem; margin-bottom: 0.25rem; color: var(--text-main);">Pilih Foto dari Komputer Anda</p>
            ...
            <div style="margin-top: 1.5rem;">
                <span style="font-size: 0.9rem; font-weight: 600; color: var(--text-main); display: block; margin-bottom: 0.75rem;">Foto yang Akan Ditambahkan:</span>
        ...
        <div class="form-actions" style="display: flex; justify-content: space-between; gap: 1rem; margin-top: 1.5rem; border-top: 1px solid var(--border); padding-top: 1.5rem;">
            ...
            <div style="margin-left: auto;">
                ...
                <button type="submit" id="btn-submit" class="btn" style="background-color: #DDA853; color: white; border: none; padding: 0.75rem 2rem; border-radius: var(--radius-md); font-weight: 600; cursor: pointer; transition: var(--transition); display: none;">Simpan Properti</button>
            </div>
        </div>
    </form>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    btnNext.addEventListener('click', function() {
        if (isStepValid()) {
            ...
            // Trigger browser native validation feedback
    ...
    function createPreviewCard(src, isLocalFile, index) {
        ...
        btnDelete.addEventListener('click', function() {
            if (isLocalFile) {
                ...
                // Reconstruct data transfer list for images_files input
