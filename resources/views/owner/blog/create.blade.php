...
@section('title', 'Managee Owner Dashboard - Tulis Artikel Baru')
...
<div class="write-blog-page">
    <div class="write-container">
        ...
        <div class="mock-header">
            <div>
                <h1 class="mock-header-title">Tulis Artikel Baru</h1>
                <p class="mock-header-subtitle">Berikan ide & panduan terbaik Anda untuk sesama pemilik properti dan penyewa</p>
            </div>
            <a href="{{ route('owner.blog.index') }}" class="close-modal-btn">
        ...
        <form action="{{ route('owner.blog.store') }}" method="POST">
            @csrf
            ...
            <div class="mock-form-group">
                ...
                <input type="text" name="title" id="title" class="mock-input" placeholder="Tulis judul yang menarik perhatian..." value="{{ old('title') }}" required>
                @error('title')
                    <span class="form-error-msg">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mock-form-group">
                ...
                <textarea name="content" id="content" class="mock-input mock-textarea mock-textarea-content" placeholder="Tulis isi artikel Anda di sini..." required>{{ old('content') }}</textarea>
                @error('content')
                    <span class="form-error-msg">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mock-form-group">
                ...
                <div class="upload-box" onclick="document.getElementById('image-url-input').focus()">
                    ...
                    <input type="url" name="image" id="image-url-input" class="mock-input" style="padding: 0; background: transparent; border-radius: 0; font-size: 0.95rem; color: var(--text-dark);" placeholder="Masukkan URL foto sampul artikel (https://...)" value="{{ old('image') }}">
                </div>
                <span style="font-size: 0.75rem; color: var(--text-light-slate); margin-top: 0.15rem; margin-left: 0.5rem; text-align: left; display: block;">
            ...
            <div class="mock-footer">
                <a href="{{ route('owner.blog.index') }}" class="btn-mock-cancel">Batal</a>
