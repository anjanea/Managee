...
@section('title', 'Managee Owner - Edit Artikel: ' . $post->title)
...
<div class="write-blog-page">
    <div class="write-container">
        ...
        <div class="mock-header">
            <div>
                <h1 class="mock-header-title">Ubah Artikel</h1>
        ...
        <form action="{{ route('owner.blog.update', $post->slug) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mock-form-group">
                ...
                <input type="hidden" name="category" id="selected-category" value="{{ old('category', $post->category) }}" required>
            ...
            <div class="mock-form-group">
                ...
                <input type="text" name="title" id="title" class="mock-input" placeholder="Tulis judul yang menarik perhatian..." value="{{ old('title', $post->title) }}" required>
                @error('title')
                    <span class="form-error-msg">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mock-form-group">
                ...
                <textarea name="content" id="content" class="mock-input mock-textarea mock-textarea-content" placeholder="Tulis isi artikel Anda di sini..." required>{{ old('content', $post->content) }}</textarea>
                @error('content')
                    <span class="form-error-msg">{{ $message }}</span>
                @enderror
            </div>
